...
\begin{figure}[H]
	...
	\includegraphics[width=0.9\linewidth]{Modelos/Figuras/regressão-linear}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.9\linewidth]{Modelos/Figuras/regressão-rfa}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.9\linewidth]{Modelos/Figuras/xgb-regressão}
	
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Modelos/Figuras/lgbm-regressão}	
